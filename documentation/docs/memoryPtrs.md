...
| 0x00000003 | cada vector ocupa 4 bytes y empiezan desde la direccion 0x00000003 y van ordenados por medio del indice de dispositivo | vectores de firmwares de los dispositivos de entrada y salida | son las direcciones a la ubicacion absoluta de el codigo de firmware que maneja cada dispositivo |
