...
Vcpu::Vcpu(VerilatedContext* _vcontextp__, const char* _vcname__)
    ...
    , irq{vlSymsp->TOP.irq}
    , irq_data{vlSymsp->TOP.irq_data}
    , irq_ack{vlSymsp->TOP.irq_ack}
    , mem_wrt_val{vlSymsp->TOP.mem_wrt_val}
    , mem_wrt_bool{vlSymsp->TOP.mem_wrt_bool}
    , mem_rdr_val{vlSymsp->TOP.mem_rdr_val}
    , mem_rdr_bool{vlSymsp->TOP.mem_rdr_bool}
    , dev_wrt_en{vlSymsp->TOP.dev_wrt_en}
    , dev_wrt_val{vlSymsp->TOP.dev_wrt_val}
    , mem_wrt_ene{vlSymsp->TOP.mem_wrt_ene}
    , mem_wrt_vale{vlSymsp->TOP.mem_wrt_vale}
    , mem_wrt_ack{vlSymsp->TOP.mem_wrt_ack}
    , mem_rdr_ack{vlSymsp->TOP.mem_rdr_ack}
    , irq_addr{vlSymsp->TOP.irq_addr}
    , mem_wrt_addr{vlSymsp->TOP.mem_wrt_addr}
    , mem_rdr_addr{vlSymsp->TOP.mem_rdr_addr}
    , dev_wrt_addr{vlSymsp->TOP.dev_wrt_addr}
    , mem_wrt_addre{vlSymsp->TOP.mem_wrt_addre}
    , rootp{&(vlSymsp->TOP)}
{
